...
static void window_load(Window *window) {
  ...
  // Setup canvas layer for background animation
  canvas_layer = layer_create(bounds);
  radial_setup(canvas_layer);
  ...
  // Enable Glancing with timeout, takeover backlight
  glancing_service_subscribe(12 * 1000, true, glancing_callback);
}
